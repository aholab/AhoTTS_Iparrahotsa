...
/******* Idiomas */
#define HTTS_LANG_ESx     // castellano
...
/* castellano */
#define HTTS_ES_PAU2x
#define HTTS_PROSOD_ES_PTH1x
#define HTTS_PROSOD_ES_DUR1x
#define HTTS_PROSOD_ES_DUR2x
#define HTTS_PROSOD_ES_POW1x

/* euskara */
#define HTTS_PROSOD_EU_PTH1
#define HTTS_PROSOD_EU_DUR1
#define HTTS_PROSOD_EU_DUR2
#define HTTS_EU_PAU1
#define HTTS_PROSOD_EU_POW1

...
-------  --------  --------  -----------------------
0.0.32	 19/07/13  Inaki	 Añadir función exptimeHMinterval para intervalos (10:30-11:15)
...
public:
	...
	//Expansi¢n de horas.
	CtI exptimeHM(CtI p, BOOL NONDELETE=FALSE);
	CtI exptimeHMinterval(CtI p);//inaki

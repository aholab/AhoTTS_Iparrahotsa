...
--------------------------------------------------------------
2.1.9    12/06/13           Inaki	Modificar detección de diptongos para dialecto iparralde
...
public:
	...
	static BOOL phIsDiptongo( Phone ph1, Phone ph2, Stress acc1, Stress acc2, BOOL phpiparralde=FALSE );
